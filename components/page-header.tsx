...
export function PageHeader({ children, showActions = true }: PageHeaderProps) {
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Nova Receita button - only show if showActions is true and we're not on new recipe page */}
            {showActions && pathname !== "/nova-receita" && (
